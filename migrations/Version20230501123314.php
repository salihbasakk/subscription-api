...
final class Version20230501123314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE purchase (id INT AUTO_INCREMENT NOT NULL, status TINYINT(1) NOT NULL, purchaseStatus TINYINT(1) NOT NULL, receipt VARCHAR(200) NOT NULL, expireDate DATETIME DEFAULT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, subscriptionId INT NOT NULL, INDEX IDX_6117D13BCA77D3A9 (subscriptionId), INDEX expireDateIdx (expireDate, purchaseStatus), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
